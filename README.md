...
La versión 1.5.1 contiene una introducción de uso, los 19 módulos acordados, exportaciones Excel/PDF,
...
validar el resultado y descargar el ZIP listo para GitHub. La canasta completa se selecciona una
sola vez: el sistema la divide automáticamente en etapas, conserva cada etapa aprobada y comprueba
la cobertura por variable durante las actualizaciones. No es un módulo de análisis y no se utiliza
