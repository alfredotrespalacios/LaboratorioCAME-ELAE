...
> **Obligatorio:** Laboratorio CAME 1.5.2 se valida y se ejecuta con Python 3.12. El archivo
...
- La construcción colombiana conserva además cada etapa completa. Al repetir la misma operación y
  periodo, solo procesa las etapas o bloques pendientes.
- Trabaje con intervalos colombianos de máximo cinco años y espere a que aparezca el ZIP antes de
  cerrar la pestaña.
- Puede publicar un ZIP de avance verificado. Reemplace siempre juntos el Parquet, el Excel y el
  JSON; la siguiente corrida leerá esa trazabilidad y continuará lo pendiente.
