...
- Versión 1.5.2 implementada el 7 de septiembre de 2026.
...
- Colombia divide automáticamente la canasta seleccionada en etapas persistentes, reutiliza una
  base parcial publicada y mantiene trazabilidad opción-serie para las actualizaciones.
- Mantenimiento procesa grupos cortos, guarda un ZIP después de cada etapa y permite publicar o
  continuar un avance aun cuando existan pendientes.
- Los selectores colombianos aceptan desde 1990 hasta la fecha actual; el mes vigente queda marcado
  como parcial y puede actualizarse nuevamente.
...
- 91 pruebas locales aprobadas; los contratos vivos quedan separados mediante la marca `live`.
