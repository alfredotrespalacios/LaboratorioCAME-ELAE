...
- Pruebas locales: 91 aprobadas; los contratos externos permanecen excluidos del chequeo local.
...
- Construcción automática: una selección de varias variables se divide en etapas sin intervención
  adicional; una segunda ejecución recupera las etapas aprobadas sin repetir sus consultas.
- Base parcial: una Demanda publicada con cobertura completa se reutiliza al solicitar la canasta
  completa y el sistema procesa únicamente las etapas restantes.
